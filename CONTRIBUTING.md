# Contributing to the Inscist REST API Guidelines
The Inscist REST API Guidelines is a Inscist-wide initiative to develop consistent design guidelines for REST APIs. The initiative requires input and feedback from a variety of individuals both inside and outside of Inscist.
...
- Reference the version of the Inscist REST API Guidelines you are using.
...
This is the repository for Inscist REST API Guidelines documentation only. Please ensure that you are opening issues in the right repository.

## Recommended setup for contributing
- Fork this repository on GitHub
- Install [Git][git] to your computer and clone your new forked repository
- Install [VS Code][vscode], [Atom][atom], or your favorite editor
...
[new-issue]: https://github.com/Inscist/api-guidelines/issues/new
[issue-search]: https://github.com/Inscist/api-guidelines/issues
