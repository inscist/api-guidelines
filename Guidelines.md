...
#### 4.4.3. Creating resources via PATCH (UPSERT semantics)
...
### 4.8. Specifying headers as query parameters
...
#### 4.10.1. Clients-specified response format
...
#### 4.10.2. Error condition responses
...
#### 6.3.1. Nested collections and properties
...
#### 6.8.3. Additional considerations
...
### 8.2. Guidelines for dates and times
#### 8.2.1. Producing dates
...
### 8.3. JSON serialization of dates and times
...
#### 8.3.2. Commentary on date formatting
...
### 9.3. Definition of a breaking change
...
### 10.2. Stepwise long running operations
...
## 11. Throttling, Quotas, and Limits
### 11.1. Principles
...
### 11.3. Retry-After and RateLimit Headers
...
### 12.7. Managing subscriptions programmatically
...
#### 12.7.4. Enumerating subscriptions
...
#### 15.1.1. Push notifications, per user flow
...
#### 15.1.2. Push notifications, firehose flow
